...
positive_settings = {
    ...
    "VNDB_TIMEOUT": VNDB_TIMEOUT,
    "VNDB_RATE_LIMIT_INTERVAL": VNDB_RATE_LIMIT_INTERVAL,
    "ANILIST_TIMEOUT": ANILIST_TIMEOUT,
    "ANILIST_RATE_LIMIT_INTERVAL": ANILIST_RATE_LIMIT_INTERVAL,
    "JIKAN_TIMEOUT": JIKAN_TIMEOUT,
    "JIKAN_RATE_LIMIT_INTERVAL": JIKAN_RATE_LIMIT_INTERVAL,
